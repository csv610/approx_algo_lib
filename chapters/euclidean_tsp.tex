...
We implement the exact Held-Karp dynamic programming baseline~\cite{held-karp62}, alongside the quadtree divide-and-conquer cycle merging heuristic which serves as the geometric partitioning engine.

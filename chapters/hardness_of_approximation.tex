...
\midrule
MAX-3SAT & $7/8 + \epsilon$ & Håstad (1997) \\
Vertex Cover & $2 - \epsilon$ & Dinur (2005, UGC) \\
Clique & $n^{1-\epsilon}$ & Hastad (1999) \\
Set Cover & $(1-\epsilon)\ln n$ & Feige (1998) \\
Graph Coloring & $n^{1-\epsilon}$ & Hastad (1999) \\
\bottomrule
\end{tabular}
\end{table}
...
Feige (1998) showed that approximating set cover within $(1-\epsilon)\ln n$ is NP-hard. This matches the $O(\ln n)$ upper bound from the greedy algorithm.

...
\begin{itemize}
    \item \textbf{Exact Vertex Cover is NP-complete} (Karp~\cite{karp72}). No polynomial-time exact algorithm exists unless P = NP.
...
\textbf{Why not better than 2?} Under the Unique Games Conjecture, no polynomial-time algorithm can achieve $(2-\epsilon)$-approximation (Khot and Regev~\cite{khot-regev08}). The factor 2 is essentially tight.

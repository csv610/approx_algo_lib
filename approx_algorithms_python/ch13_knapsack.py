"""
Chapter 13: Knapsack and FPTAS
================================
Vazirani Ch. 13 (notes): Knapsack FPTAS via dynamic programming with rounding.

This is one of the classic FPTAS examples in the book.
"""
...
def knapsack_fptas(weights: List[int], values: List[int], capacity: int, 
    ...
    """
    FPTAS for 0/1 Knapsack (Vazirani, Section 13.2 / standard).
...
def demo_knapsack():
    print("=" * 60)
    print("Chapter 13: Knapsack FPTAS")
    print("=" * 60)
